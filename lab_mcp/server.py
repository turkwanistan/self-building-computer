...
def lab_status() -> dict[str, Any]:
    ...
    return {"name": "optiplex-lab", "generation": build.get("generation"), "build_id": build.get("build_id"), "source_sha256": _sha(source_bytes),
            ...
            "commands": {"self_test": "/opt/optiplex-lab/selftest.py", "benchmark": "/opt/optiplex-lab/bench/benchmark.py", "failure_miner": "/opt/optiplex-lab/bench/failure_miner.py", "code_mode": "/opt/optiplex-lab/code_mode.py", "workflows": "/opt/optiplex-lab/workflow_skills.py", "graphs": "/opt/optiplex-lab/workflow_graphs.py", "rollback": "/usr/local/sbin/optiplex-lab-rollback"}, 'capability_forge': {"path": "/opt/optiplex-lab/capability_forge.py", "available": Path("/opt/optiplex-lab/capability_forge.py").is_file(), "sha256": _sha(Path("/opt/optiplex-lab/capability_forge.py").read_bytes()) if Path("/opt/optiplex-lab/capability_forge.py").is_file() else None, "version": "gen5-capability-forge-r1", "registry": "/var/lib/optiplex-lab/capabilities/registry.json"}}
