...
def lab_status() -> dict[str, Any]:
    ...
    return {"name": "optiplex-lab", "generation": build.get("generation"), "build_id": build.get("build_id"), "source_sha256": _sha(source_bytes),
            ...
            "commands": {"self_test": "/opt/optiplex-lab/selftest.py", "benchmark": "/opt/optiplex-lab/bench/benchmark.py", "failure_miner": "/opt/optiplex-lab/bench/failure_miner.py", "code_mode": "/opt/optiplex-lab/code_mode.py", "workflows": "/opt/optiplex-lab/workflow_skills.py", "graphs": "/opt/optiplex-lab/workflow_graphs.py", "rollback": "/usr/local/sbin/optiplex-lab-rollback"}}
